...
class TestArgParsing:
    ...
    def test_scale_argument(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "sys.argv", ["fenc", "input.mkv", "output.mp4", "--scale", "1280:720"]
        )
        args = parse_args()
    ...
    def test_hls_custom_time(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "sys.argv", ["fenc", "input.mkv", "output.m3u8", "--hls", "--hls_time", "6"]
        )
        args = parse_args()
    ...
    def test_subtitle_index(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "sys.argv", ["fenc", "input.mkv", "output.mp4", "--subtitle_index", "2"]
        )
        args = parse_args()
    ...
    def test_target_bitrate(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "sys.argv", ["fenc", "input.mkv", "output.mp4", "--target_bitrate", "5000"]
        )
        args = parse_args()
    ...
    def test_letterbox_flag(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "sys.argv", ["fenc", "input.mkv", "output.mp4", "--letterbox"]
        )
        args = parse_args()
    ...
    def test_dry_run(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "sys.argv", ["fenc", "input.mkv", "output.mp4", "--dry_run"]
        )
        args = parse_args()
    ...
    def test_no_progress_flag(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "sys.argv", ["fenc", "input.mkv", "output.mp4", "--no-progress"]
        )
        args = parse_args()
    ...
    def test_single_file_extra_subtitle_dir_file_is_used(self, monkeypatch, tmp_path):
